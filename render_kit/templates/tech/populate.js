#!/usr/bin/env node
// Tech template generator: data.json → videos/<slug>/ HyperFrames project.
// Same mechanism as templates/chemistry/populate.js, plus dual-orientation
// support: config.orientation picks the canvas (vertical 1080×1920 default,
// horizontal 1920×1080) and is injected as an {{orientation}} token that
// every frame uses as a root class to switch between its two layouts.
