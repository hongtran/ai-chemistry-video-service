...
export const FRAME_DEFAULTS = {
  ...
  cover:               { ...SHARED, headlineFontSize: '120px', image: PLACEHOLDER_IMAGE, imagePrompt: '' },
  ...
  cta:                 { ...SHARED, image: PLACEHOLDER_IMAGE, imagePrompt: '' },
  ...
  photo:               { ...SHARED, image: PLACEHOLDER_IMAGE, imagePrompt: '' },
  'photo-split':       { ...SHARED, image: PLACEHOLDER_IMAGE, imagePrompt: '', body: '' },
};
...
export const TYPE_CONTENT_FIELDS = {
  ...
  diagram: ['items'],
  cta: ['subheadline', 'image', 'imagePrompt'],
  ...
  photo: ['image', 'imagePrompt'],
  'photo-split': ['image', 'imagePrompt', 'body'],
};
